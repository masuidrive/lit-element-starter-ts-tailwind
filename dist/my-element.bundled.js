...
let et=class extends Q{constructor(){super(...arguments),this.name="World",this.count=0}render(){return O`
      ...
      <slot></slot>
    `}_onClick(){this.count++,this.dispatchEvent(new CustomEvent("count-changed"))}sayHello(t){return`Hello, ${t}`}};et.styles=n`.static {
    position\: static
}
.text-purple-400 {
    --tw-text-opacity\: 1;
